...
/***/ function(module, exports, __webpack_require__) {
	...
	var _viewsAppView = __webpack_require__(1);
	...
	(0, _jquery2['default'])(function () {
	  console.log('Starting uo the application!');
	  new _viewsAppView.AppView().render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = _backbone2['default'].View;
	var Collection = _backbone2['default'].Collection;
	var Router = _backbone2['default'].Router;
	var LocalStorage = _backbone2['default'].LocalStorage;
	...
	var AppView = (function (_View) {
	  ...
	  function AppView() {
	    ...
	    this.setElement((0, _jquery2['default'])('#theapp'), true);
	    this.template = _lodash2['default'].template((0, _jquery2['default'])('#item-template').html());
	  }
